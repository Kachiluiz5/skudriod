...
<!-- Mirrored from demo.yolotheme.com/giraffe/events/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 10:22:07 GMT -->
...
<style id="yolo_giraffe_options-dynamic-css" title="dynamic-css" class="redux-options-output">body{background-repeat:no-repeat;background-attachment:fixed;background-position:center center;background-size:cover;}#yolo-wrapper{background-color:#ffffff;}.page-title-margin{margin-top:0;margin-bottom:80px;}.page-title-height{}.archive-title-height{}.single-blog-title-height{}.archive-product-title-height{}.single-product-title-height{}body{font-family:Montserrat;font-weight:500;font-style:normal;font-size:14px;font-display:swap;}h1{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:36px;font-display:swap;}h2{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:30px;font-display:swap;}h3{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:26px;font-display:swap;}h4{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:22px;font-display:swap;}h5{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:18px;font-display:swap;}h6{font-family:"Fredoka One";font-weight:400;font-style:normal;font-size:14px;font-display:swap;}.page-title-inner h1{font-family:"Fredoka One";text-transform:capitalize;font-weight:400;font-style:normal;font-size:36px;font-display:swap;}.page-title-inner .page-sub-title{font-family:Montserrat;text-transform:none;font-weight:500;font-style:normal;font-size:15px;font-display:swap;}.archive-teacher-title-height{}.single-teacher-title-height{}.archive-class-title-height{}.single-class-title-height{}.archive-event-title-height{}.single-event-title-height{}</style><noscript><style> .wpb_animate_when_almost_visible { opacity: 1; }</style></noscript>	</head>
	<!-- Close Head -->
	<body class="archive post-type-archive post-type-archive-yolo_event custom-background theme-yolo-giraffe woocommerce-no-js yolo-timetable-page event-page yolo-site-preload header-4 woocommerce wpb-js-composer js-comp-ver-6.5.0 vc_responsive">
		<div class="site">
		...
		<div class="yolo-modal-dialog yolo-modal-search fade in">
			...
			<div class = "yolo-search-result">
				...
				<div id="yolo-content-wrapper" class="clearfix" style="background: #ffffff; ">
                    ...
                    <section class="page-title-wrap-bg yolo-page-title-wrap" style="background-image: url(../wp-content/themes/yolo-giraffe/assets/images/bg-page-title.jpg);height:300px">
	...
	<div class="container clearfix">
		<div class="row clearfix sidebar-right has-sidebar ">
			<div class="site-content-archive-inner col-lg-8 col-md-12">
				<div class="yolo-archive-event  grid">
					<div class="posts-loop-content row">
													
								
<article class=" event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-99 filter-cat-92 filter-organizer-3632 post-981 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-environment event_category-events">
    <div class="loop-item-wrap">
        <a class="featured-link" href="summer-camp/index.php" title="Summer Camp">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-06.jpg')">
                </div>
                                    <div class="date" style="color: #48CFAD">
                        <span>29</span><br>
                        <span>May</span>
                    </div>
                            </div>
        </a>
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            42 Stryker St, Brooklyn, NY 11223, USA                                        </span>
                <h4 class="title">
                    <a href="summer-camp/index.php">Summer Camp</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">9:35 am - 2:35 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_55967e event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-99 filter-cat-92 filter-organizer-3632 post-978 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-environment event_category-events">
    <div class="loop-item-wrap">
        <a class="featured-link" href="music-for-toddlers/index.php" title="Music for Toddlers">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-07.jpg')">
                </div>
                                    <div class="date" style="color: #f05c5c">
                        <span>23</span><br>
                        <span>Jul</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            308 York St, Jersey City, NJ 07302, USA                                        </span>
                <h4 class="title">
                    <a href="music-for-toddlers/index.php">Music for Toddlers</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">3:30 pm - 7:30 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_eb9f9f event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-131 filter-cat-91 filter-organizer-3632 post-3286 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-art event_category-course">
    <div class="loop-item-wrap">
        <a class="featured-link" href="science-class-for-toddlers/index.php" title="Science Class for Toddlers">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-09.jpg')">
                </div>
                                    <div class="date" style="color: #FFCE54">
                        <span>29</span><br>
                        <span>Apr</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            507 5th Ave, New York, NY 10017, USA                                        </span>
                <h4 class="title">
                    <a href="science-class-for-toddlers/index.php">Science Class for Toddlers</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">2:45 pm - 6:45 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_47b8e0 event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-99 filter-cat-93 filter-organizer-3632 post-976 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-environment event_category-teachers">
    <div class="loop-item-wrap">
        <a class="featured-link" href="family-field-day/index.php" title="Family Field Day">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-03.jpg')">
                </div>
                                    <div class="date" style="color: #2ECC71">
                        <span>22</span><br>
                        <span>May</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            455 Washington, Jersey City, NJ, USA                                        </span>
                <h4 class="title">
                    <a href="family-field-day/index.php">Family Field Day</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">2:30 pm - 7:30 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_60c5ba event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-99 filter-cat-92 filter-organizer-3632 post-975 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-environment event_category-events">
    <div class="loop-item-wrap">
        <a class="featured-link" href="giraffe-kite-festival/index.php" title="Giraffe Kite Festival">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-10.jpg')">
                </div>
                                    <div class="date" style="color: #56d47e">
                        <span>25</span><br>
                        <span>Jun</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            117 Grand St, New York, NY 10013, USA                                        </span>
                <h4 class="title">
                    <a href="giraffe-kite-festival/index.php">Giraffe Kite Festival</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">10:30 am - 12:30 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_e3e36a event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-98 filter-cat-99 filter-cat-92 filter-organizer-3632 post-973 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-activities event_category-environment event_category-events">
    <div class="loop-item-wrap">
        <a class="featured-link" href="math-party/index.php" title="Math Party">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-01.jpg')">
                </div>
                                    <div class="date" style="color: #A0CECB">
                        <span>7</span><br>
                        <span>May</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            1348 6th Ave, New York, NY 10019, USA                                        </span>
                <h4 class="title">
                    <a href="math-party/index.php">Math Party</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">7:35 am - 10:35 am</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_ef5285 event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-131 filter-cat-92 filter-cat-93 filter-organizer-3632 post-970 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-art event_category-events event_category-teachers">
    <div class="loop-item-wrap">
        <a class="featured-link" href="childhood-colors/index.php" title="Childhood Colors">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-13.jpg')">
                </div>
                                    <div class="date" style="color: #1ec0ff">
                        <span>22</span><br>
                        <span>Apr</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            2700 New York Ave NE, Washington, USA                                        </span>
                <h4 class="title">
                    <a href="childhood-colors/index.php">Childhood Colors</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">9:35 am - 1:35 pm</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
...
<article class="event_f1bbba event-item layout-2 col-sm-6 col-md-6 col-lg-6 filter-cat-131 filter-cat-132 filter-organizer-3632 post-960 yolo_event type-yolo_event status-publish has-post-thumbnail hentry event_category-art event_category-paint">
    <div class="loop-item-wrap">
        <a class="featured-link" href="painting-class-for-young/index.php" title="Painting Class for Young">
            <div class="loop-item-featured">
                <div class="item-featured-bg" style="background-image: url('../wp-content/uploads/2018/10/event-05.jpg')">
                </div>
                                    <div class="date" style="color: #EC87C0">
                        <span>17</span><br>
                        <span>Jun</span>
                    </div>
                            </div>
        ...
        <div class="evi__content loop-item-content">
            <div class="evi__title item-title">
                <span class="location">
                                                    <i class="fas fa-map-marker-alt"></i>
                            636 Washington St, Hoboken, NJ 07030, USA                                        </span>
                <h4 class="title">
                    <a href="painting-class-for-young/index.php">Painting Class for Young</a>
                </h4>
            </div>
            <div class="item-meta">
                <div class="time">
                    <span class="schedule"><i class="far fa-clock"></i>
                        <span class="time__event">7:00 am - 10:00 am</span>
                    </span>
                </div>
                    <div class="price">
                        <span>$59</span>
	...
	<li><a class="next page-numbers" href="page/2/index.php"><i class="fas fa-chevron-right"></i></a></li>
			...
			<div class="yolo-sidebar ">
						             <div class="widget widget-event-filters">
		             	<h4 class="widget-title">Event Filter</h4>
		             	<div class="widget-content-wrap">
				                    ...
				                    <select class="widget-event-filter-control">
				                        <option value="">Select Category</option>
				                        				                            <option value="event_category-activities">Activities</option>
				                        				                            <option value="event_category-art">Art</option>
				                        				                            <option value="event_category-course">Course</option>
				                        				                            <option value="event_category-environment">Environment</option>
				                        				                            <option value="event_category-events">Events</option>
				                        				                            <option value="event_category-paint">Paint</option>
				                        				                            <option value="event_category-teachers">Teachers</option>
				                        				                    </select>
				                </div>
				            				            				                <div class="widget-event-filter search-event -organizer" data-group="organizer">
				                    <select class="widget-event-filter-control">
				                        <option value="">Select Organizer</option>
				                        				                            <option value="filter-organizer-3632">An  Pre-School</option>
				                        				                            <option value="filter-organizer-3631">Sunflower School</option>
				                        				                            <option value="filter-organizer-180">Giraffe School</option>
				                        				                    </select>
				                </div>
			            				            </div>
		            </div>
...
<script type='text/javascript' src='../wp-content/plugins/yolo-timetable/assets/js/yolo_event.js' id='yolo-event-js'></script>
...
<!-- Mirrored from demo.yolotheme.com/giraffe/events/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 10:22:10 GMT -->
</html>